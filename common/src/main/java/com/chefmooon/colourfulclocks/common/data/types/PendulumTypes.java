...
public enum PendulumTypes implements StringRepresentable {
    ...
    EXPOSED_COPPER(3, BuiltInRegistries.ITEM.get(ColourfulClocksItems.EXPOSED_COPPER_PENDULUM), "exposed_copper", 2.0F, ColourfulClocksSounds.ITEM_EXPOSED_COPPER_PENDULUM_CHIME, 0.8F, ItemStack.EMPTY.getItem()),
    WEATHERED_COPPER(4, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WEATHERED_COPPER_PENDULUM), "weathered_copper", 2.0F, ColourfulClocksSounds.ITEM_WEATHERED_COPPER_PENDULUM_CHIME, 0.7F, ItemStack.EMPTY.getItem()),
    OXIDIZED_COPPER(5, BuiltInRegistries.ITEM.get(ColourfulClocksItems.OXIDIZED_COPPER_PENDULUM), "oxidized_copper", 2.0F, ColourfulClocksSounds.ITEM_OXIDIZED_COPPER_PENDULUM_CHIME, 0.6F, ItemStack.EMPTY.getItem()),
    ...
    WAXED_EXPOSED_COPPER(7, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WAXED_EXPOSED_COPPER_PENDULUM), "waxed_exposed_copper", 2.0F, ColourfulClocksSounds.ITEM_EXPOSED_COPPER_PENDULUM_CHIME, 0.8F, ItemStack.EMPTY.getItem()),
    WAXED_WEATHERED_COPPER(8, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WAXED_WEATHERED_COPPER_PENDULUM), "waxed_weathered_copper", 2.0F, ColourfulClocksSounds.ITEM_WEATHERED_COPPER_PENDULUM_CHIME, 0.7F, ItemStack.EMPTY.getItem()),
    WAXED_OXIDIZED_COPPER(9, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WAXED_OXIDIZED_COPPER_PENDULUM), "waxed_oxidized_copper", 2.0F, ColourfulClocksSounds.ITEM_OXIDIZED_COPPER_PENDULUM_CHIME, 0.6F, ItemStack.EMPTY.getItem()),
