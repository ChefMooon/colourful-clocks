...
public enum PendulumTypes implements StringRepresentable {
    ...
    IRON(1, BuiltInRegistries.ITEM.get(ColourfulClocksItems.IRON_PENDULUM), "iron", 2.0F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 1.0F, Items.IRON_INGOT),
    COPPER(2, BuiltInRegistries.ITEM.get(ColourfulClocksItems.COPPER_PENDULUM), "copper", 2.0F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.9F, Items.COPPER_INGOT),
    EXPOSED_COPPER(3, BuiltInRegistries.ITEM.get(ColourfulClocksItems.EXPOSED_COPPER_PENDULUM), "exposed_copper", 1.5F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.8F, ItemStack.EMPTY.getItem()),
    WEATHERED_COPPER(4, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WEATHERED_COPPER_PENDULUM), "weathered_copper", 1.0F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.7F, ItemStack.EMPTY.getItem()),
    OXIDIZED_COPPER(5, BuiltInRegistries.ITEM.get(ColourfulClocksItems.OXIDIZED_COPPER_PENDULUM), "oxidized_copper", 0.5F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.6F, ItemStack.EMPTY.getItem()),
    WAXED_COPPER(6, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WAXED_COPPER_PENDULUM), "waxed_copper", 2.0F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.9F, Items.COPPER_INGOT),
    WAXED_EXPOSED_COPPER(7, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WAXED_EXPOSED_COPPER_PENDULUM), "waxed_exposed_copper", 1.5F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.8F, ItemStack.EMPTY.getItem()),
    WAXED_WEATHERED_COPPER(8, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WAXED_WEATHERED_COPPER_PENDULUM), "waxed_weathered_copper", 1.0F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.7F, ItemStack.EMPTY.getItem()),
    WAXED_OXIDIZED_COPPER(9, BuiltInRegistries.ITEM.get(ColourfulClocksItems.WAXED_OXIDIZED_COPPER_PENDULUM), "waxed_oxidized_copper", 0.5F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.6F, ItemStack.EMPTY.getItem()),
    GOLD(10, BuiltInRegistries.ITEM.get(ColourfulClocksItems.GOLD_PENDULUM), "gold", 1.5F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.5F, Items.GOLD_INGOT),
    ...
    NETHERITE(12, BuiltInRegistries.ITEM.get(ColourfulClocksItems.NETHERITE_PENDULUM), "netherite", 0.5F, ColourfulClocksSounds.ITEM_BASE_PENDULUM_CHIME, 0.3F, Items.NETHERITE_INGOT),
