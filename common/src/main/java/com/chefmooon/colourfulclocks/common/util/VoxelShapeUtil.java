...
public class VoxelShapeUtil {
    ...
    public static ConcurrentHashMap<Direction, VoxelShape> getRotatedShapesMap(VoxelShape shape) {
        ConcurrentHashMap<Direction, VoxelShape> rotatedShapes = new ConcurrentHashMap<>();
        rotatedShapes.put(Direction.NORTH, shape);
        rotatedShapes.put(Direction.EAST, rotateVoxelShape(shape, Direction.EAST));
        rotatedShapes.put(Direction.SOUTH, rotateVoxelShape(shape, Direction.SOUTH));
        rotatedShapes.put(Direction.WEST, rotateVoxelShape(shape, Direction.WEST));
