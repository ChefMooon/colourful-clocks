...
public enum HandbellTypes implements StringRepresentable {
    ...
    IRON(0, "iron", Items.IRON_INGOT, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.FULL.getValue(), Pitch.FULL.getValue()),
    COPPER(1, "copper", Items.COPPER_INGOT, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.FULL.getValue(), Pitch.FULL.getValue()),
    EXPOSED_COPPER(2, "exposed_copper", Items.AIR, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.THREE_QUARTER.getValue(), Pitch.THREE_QUARTER.getValue()),
    WEATHERED_COPPER(3, "weathered_copper", Items.AIR, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.HALF.getValue(), Pitch.HALF.getValue()),
    OXIDIZED_COPPER(4, "oxidized_copper", Items.AIR, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.QUARTER.getValue(), Pitch.QUARTER.getValue()),
    WAXED_COPPER(5, "waxed_copper", Items.AIR, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.FULL.getValue(), Pitch.FULL.getValue()),
    WAXED_EXPOSED_COPPER(6, "waxed_exposed_copper", Items.AIR, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.THREE_QUARTER.getValue(), Pitch.THREE_QUARTER.getValue()),
    WAXED_WEATHERED_COPPER(7, "waxed_weathered_copper", Items.AIR, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.HALF.getValue(), Pitch.HALF.getValue()),
    WAXED_OXIDIZED_COPPER(8, "waxed_oxidized_copper", Items.AIR, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.QUARTER.getValue(), Pitch.QUARTER.getValue()),
    GOLD(9, "gold", Items.GOLD_INGOT, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.THREE_QUARTER.getValue(), Pitch.THREE_QUARTER.getValue()),
    ...
    NETHERITE(11, "netherite", Items.NETHERITE_INGOT, ColourfulClocksSounds.ITEM_BASE_HANDBELL_RING, ColourfulClocksSounds.ITEM_BASE_HANDBELL_HIT, SwingSpeed.QUARTER.getValue(), Pitch.QUARTER.getValue()),
