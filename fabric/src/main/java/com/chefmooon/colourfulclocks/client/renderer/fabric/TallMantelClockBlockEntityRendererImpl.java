...
public class TallMantelClockBlockEntityRendererImpl<T extends TallMantelClockBlockEntity> extends TallMantelClockBlockEntityRenderer implements BlockEntityRenderer<T> {
