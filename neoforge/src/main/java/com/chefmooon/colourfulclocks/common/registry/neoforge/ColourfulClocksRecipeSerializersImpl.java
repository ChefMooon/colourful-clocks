...
public class ColourfulClocksRecipeSerializersImpl {
    ...
    public static final Supplier<RecipeSerializer<?>> CLOCK = RECIPE_SERIALIZERS.register(ColourfulClocksRecipeSerializers.CLOCK.getPath(), ClockDataShapedRecipe.Serializer::new);
