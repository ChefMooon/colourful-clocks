...
public class ColourfulClocksRecipeSerializersImpl {
    ...
    public static final Supplier<RecipeSerializer<?>> HANDBELL_HANDLE = RECIPE_SERIALIZERS.register(ColourfulClocksRecipeSerializers.HANDBELL_HANDLE.getPath(), HandbellHandleShapelessRecipe.Serializer::new);
