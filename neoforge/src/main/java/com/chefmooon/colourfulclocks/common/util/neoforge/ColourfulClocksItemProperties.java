...
public class ColourfulClocksItemProperties {
    ...
    private static void registerPocketWatch(Item item) {
        ItemProperties.register(
                item, ResourceLocation.fromNamespaceAndPath(ColourfulClocks.MOD_ID, "open"),
                (stack, level, entity, seed) -> Boolean.TRUE.equals(stack.get(ColourfulClocksDataComponentTypesImpl.POCKET_WATCH_OPEN.get())) ? 1.0F : 0.0F
        );
