...
public class MantelClockBlockEntityRendererImpl extends MantelClockBlockEntityRenderer implements BlockEntityRenderer<MantelClockBlockEntity> {
    public MantelClockBlockEntityRendererImpl(BlockEntityRendererProvider.Context context) {
    }

    @SuppressWarnings("deprecation")
    @Override
    public void render(MantelClockBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
